...
for stock in list_of_10_stocks:
    dict_of_scaler[stock] = joblib.load(os.path.abspath(os.path.join(cwd,'..',f'notebooks/{stock}_scaler.joblib')))
    dict_of_model[stock] = load_model(os.path.abspath(os.path.join(cwd,'..',f'notebooks/{stock}_model.h5')))
